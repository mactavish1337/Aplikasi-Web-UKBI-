    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_tambah_soal" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="soal">Soal</label>
                        <textarea name="soal" id="soal" cols="50" rows="10" class="form-control" placeholder="isikan soal"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Audio (khusus soal listening)</label>
                        <input class="form-control" type="file" accept=".mp3" name="audio" id="formFile">
                    </div>
